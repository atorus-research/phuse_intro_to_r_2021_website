...
These two methods yeild the **same results**, but the convention is to use `<-`. Learn more [here](https://stat.ethz.ch/R-manual/R-patched/library/base/html/assignOps.html)
